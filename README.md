...
* **Product**: Discovery, roadmapping, PRDs, user interviews, GTM, pricing, experiment design
* **AI & Technical**: LLM evaluations, multi-agent workflows, prompt design, RAG, Python, SQL, Git
* **Design & Tools**: Figma, Vite, React, Tailwind, Linear, Jira, Mixpanel, Amplitude, Tableau
